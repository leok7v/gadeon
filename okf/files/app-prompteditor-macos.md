...
served once the view has a window and reported from the responder
overrides, see `the-composer-focus-is-a-request-and-a-report`; a paste or
text drag at or over `ChatModel.pasteAttachBytes` becomes a Text attachment
(`attachment-inline-refs`).
