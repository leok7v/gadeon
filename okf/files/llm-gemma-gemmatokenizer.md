...
metaspace, byte fallback, ignore_merges, token types, and the fact that
gemma stops on three ids rather than one. A second implementation beside
Tokenizer.swift, not a branch of it.
