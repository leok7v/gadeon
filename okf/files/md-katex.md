...
survive a re-import: the font resolves through Bundle.module, the value
types carry Sendable, layout AND draw hold one lock over the shared font,
and the file is single-exit throughout.
