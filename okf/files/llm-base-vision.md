...
photo never materialises its full bitmap), makes the chip thumbnail with the
EXIF transform applied and the tower decode without it, and turns a CGImage
back into a JPEG for the stored transcript. `nativeSize` is HF's
