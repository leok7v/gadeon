...
overlays. Find highlighting uses layout-manager TEMPORARY attributes, which
do not mutate storage, so code and table backgrounds survive and the
incremental attribute diff is undisturbed.
