...
arithmetic in the same sequence, so the WAV byte comparison stays
meaningful. Only the tracing and the host memory choreography were dropped,
and both are bit neutral by construction.
